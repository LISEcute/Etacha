...
//
// $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
double  EnergyResidueFromRange(double Zp, double Ap,  double Zt, double At, double E, double thick)
{
double RG   = RANGE( Ap, Zp, At, Zt, E);
       RG  -= thick;

double E_final = ENERGY( Ap, Zp, At, Zt, RG);
...
// *********************************************************************
      ...
      Y1 = 1.0 +F[1]*Z+F[2]*pow_int(Z,2)+F[3]*pow_int(Z,3)+F[4]*pow_int(Z,4);
      Y2 = F[5]+F[6]*Z;
      Y3 = F[7]+F[8]*Z;
      Y4 = F[9]+F[10]*Z;
//      Y5 = Y3/(2.0*Y4);
